 ...
 * Usman Khan
 */
public class LargerBullets extends Actor
{
    Space currentWorld;
    static boolean setCounter3 = false;
    int timer = 0;

    public LargerBullets() {  //Changing powerup image size
    ...
    /**
     * Act - do whatever the LargerBullets wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if (rocket != null) {   //Detects if rocket is touching powerup
            Rocket.bulletSize = 80;   //Increases bullet size to 80
            setCounter3 = true;     //Boolean to check if powerup is activated
